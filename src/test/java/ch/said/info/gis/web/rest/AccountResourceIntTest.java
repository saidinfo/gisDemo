...
import ch.said.info.gis.config.Constants;
import ch.said.info.gis.GisDemoApp;
import ch.said.info.gis.domain.Authority;
import ch.said.info.gis.domain.User;
import ch.said.info.gis.repository.AuthorityRepository;
import ch.said.info.gis.repository.UserRepository;
import ch.said.info.gis.security.AuthoritiesConstants;
import ch.said.info.gis.service.MailService;
import ch.said.info.gis.service.dto.UserDTO;
import ch.said.info.gis.web.rest.errors.ExceptionTranslator;
import ch.said.info.gis.web.rest.vm.KeyAndPasswordVM;
import ch.said.info.gis.web.rest.vm.ManagedUserVM;
import ch.said.info.gis.service.UserService;
...
@SpringBootTest(classes = GisDemoApp.class)
